...
function Notes(props) {
  ...
  const {notes,deleteNote}  = props;
    ...
    <div className="bg-yellow-900 text-black  space-x-20 flex rounded-lg w-full h-auto my-5  ">
      {notes.map((note)=>{
        return(
          <div key={note.id}  className='flex space-x-5 bg-green-900 p-5  rounded-lg justify-content: flex-start;'>
          <div>
