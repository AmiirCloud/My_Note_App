...
function Notes(props) {
  ...
  const {notes,deleteNote}  = props;
    ...
    <div className="bg-yellow-900  flex flex-wrap space-y-10 justify-center rounded-lg w-full  h-auto my-5 md:flex flex-no-wrap ">
      {notes.map((note)=>{
        return(
          <div key={note.id}  className='flex   bg-black p-5  text-gray-200 rounded-lg '>
          <div className="w-full h-60 p-3  bg-green-900">
