...
function Notes(props) {
  ...
  const {notes,deleteNote}  = props;
    ...
    <div className="bg-yellow-900  flex flex-wrap space-y-10 md:space-y-0 justify-center rounded-lg w-full  h-auto my-5  ">
      {notes.map((note)=>{
        return(
          <div key={note.id}  className= ' md:w-1/4 ml-5 bg-black p-5  text-gray-200 rounded-lg '>
                  <div className="">
