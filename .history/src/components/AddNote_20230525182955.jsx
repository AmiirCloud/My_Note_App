...
const validationSchema  = Yup.object({
  ...
  return (
    <div className='bg-gray-100 h-100  w-1/2'>
     ...
     <Field className='h-10 text-center  w-full  rounded-lg'  type="text" placeholder="Title" name ="title" />
     <ErrorMessage name = "title"/>
     
     <Field className='h-10  w-full   rounded-lg'  type="text" placeholder="Body" name ="body" />
     <div className='text-red-600 pl-2  border  border-red-600 border-1'>
